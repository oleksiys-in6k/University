...
public class CoursesController {
    ...
    public ModelAndView index() {
        ModelAndView model = new ModelAndView("courses/index");
    ...
    public ModelAndView newCourse() {
        ModelAndView model = new ModelAndView("courses/new");
...
//        ModelAndView modelAndView = new ModelAndView("courses/edit");
